...
interface MovementSelectionSheetProps {
  activities: AvailableActivity[];
  onSelectActivity: (activity: AvailableActivity) => void;
  onClose: () => void;
}

export const MovementSelectionSheet = forwardRef<BottomSheet, MovementSelectionSheetProps>(
        ...
        <BottomSheetView style={styles.contentContainer}>
          ...
          <View style={styles.header}>
            <View style={styles.headerTitleContainer}>
              <Text style={styles.title}>Select resource activity</Text>
